...
Route::prefix('admin')->name('admin.')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::post('trainer/restore/{id}', [TrainerController::class, 'restore'])->name('trainer.restore');
        Route::delete('trainer/force-delete/{id}', [TrainerController::class, 'forceDelete'])->name('trainer.force-delete');
        Route::get('trainer/deleted', [TrainerController::class, 'deleted'])->name('trainers.deleted');
        //..........................................Equipment Route.........................................................
        ...
        Route::post('restore/{id}', [MembershipPlanController::class, 'restore'])->name('membership-plan.restore');
        Route::delete('force-delete/{id}', [MembershipPlanController::class, 'forceDelete'])->name('membership-plan.force-delete');
        Route::get('deleted', [MembershipPlanController::class, 'deleted'])->name('membership-plans.deleted');
